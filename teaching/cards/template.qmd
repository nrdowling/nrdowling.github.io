...
::: card-header
### <i class="bi bi-arrow-right-circle-fill"></i> UPCOMING: FALL 2024 
:::

#### Perspectives in Social Science Analysis {.card-title}
#####  MAPS 30000 Sections 7 & 8 {.card-subtitle}

![](cards/CLASS-banner.svg){.class-banner fig-alt="alt text"}
...
[Course catalog](#){.card-link}
[Sample syllabus](files/syllabi/course.pdf){.card-link}

:::
::: {.card-footer .text-muted}
Upcoming: QQ YEAR </br> Concluded: QQ YEAR
:::
:::
